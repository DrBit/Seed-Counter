 ...
 */
 ...
 // INCLUDES
//#include <ioavr.h>  // needs to stay?
//#include "sm_driver.h"  // this needs to stay
...
////////////////////////
  ...
  //volatile unsigned char cmd:1;
  //! Dummy bits to fill up a byte.
  //volatile unsigned char dummy:6;
...
// Timer/Counter 1 running on 16 MHz / 8 = 2000 kHz (500nS - 0.5uS). (T1-FREQ 2000000)
#define T1_FREQ 2000000   // Timer 1 Frequency in Hz
//! Number of (full)steps per round on stepper motor in use.
#define FSPR 200
// DELETE?
#define SPR 200
// Motor mode -- needed? check-------
/*
#ifdef HALFSTEPS
  #define SPR (FSPR*2)
